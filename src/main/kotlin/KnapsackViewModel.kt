...
class KnapsackViewModel {
    ...
    fun solve() {
        ...
        val res = knapsackModel.solveKnapsack(items.value, capacity.value)
        println("Solve result: $res")  // <-- Aquí
        result.value = knapsackModel.solveKnapsack(items.value, capacity.value)
        errorMessage.value = null
    }
